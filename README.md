# Sébastien Morris | Software Engineer
...
### Active Projects
* **Custom C++ Engine:** Designing a Game Engine using a C++ simulation and DirectX12 Rendering backend with C#/WPF user interface frontend.
* **F1 Live Data Telemetry Software:** Developing a software for sim-racing performance and data tracking. Retrieving and analysing real-time data from the F1 game through a Python backend, and displaying live racing data telemetry using a C#/WPF user interface frontend.
